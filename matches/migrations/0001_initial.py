...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('matches_match', (
            ...
            ('asterisk', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('matches', ['Match'])

        # Adding model 'Play'
        db.create_table('matches_play', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('matches', ['Play'])
    ...
    models = {
        ...
        'matches.match': {
            ...
            'asterisk': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['games.Game']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'players': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['players.Player']", 'through': "orm['matches.Play']", 'symmetrical': 'False'})
        },
        'matches.play': {
